...
function displayRegisterMassage($flag)
{

    if ($flag == -1) {
        echo ' <div class="alert alert-danger alert-dismissible fade show my-3 text-start" role="alert">
               <i class="bi bi-exclamation-octagon me-1"></i>
                   Gagal Tambah Data
               <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
           </div>';
        ...
        echo ' <div class="alert alert-success alert-dismissible fade show my-3 text-start" role="alert">
               <i class="bi bi-exclamation-octagon me-1"></i>
...
function displayHapusMassage($flag)
{
