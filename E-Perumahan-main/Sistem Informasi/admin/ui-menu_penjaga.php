...
<!--                <li>-->
<!--                    <a href="penjaga/list-user.php?user_role=tamu">-->
<!--                        <i class="bi bi-circle"></i><span>Tamu</span>-->
<!--                    </a>-->
<!--                </li>-->
                <li>
                    <a href="penjaga/list-user.php?user_role=warga">
                        <i class="bi bi-circle"></i><span>Warga</span>
                    </a>
                </li>
                <li>
                    <a href="penjaga/list-user.php?user_role=penjaga">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="penjaga/history-tamu.php">
                        <i class="bi bi-circle"></i><span>Tamu (Bertamu)</span>
                    </a>
                </li>
<!--                <li>-->
<!--                    <a href="penjaga/history-warga.php">-->
...
<!--        </li>-->
        <!-- End Tables Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="penjaga/streaming.php">
                <i class="bi bi-tv"></i>
                <span>Streaming</span>
            </a>
        </li>
